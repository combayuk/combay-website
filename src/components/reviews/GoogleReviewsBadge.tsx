  ...
  return (
    <section className="border-y border-slate-200 bg-white py-7">
      <div className="site-shell">
        <div className="flex flex-col gap-4 rounded-2xl border border-slate-200 bg-[#F8FAFC] p-5 shadow-sm sm:flex-row sm:items-center sm:justify-between">
          <a href={REVIEWS_URL} target="_blank" rel="noopener noreferrer" className="group flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-4">
            ...
            <div>
              ...
              <p className="text-sm font-700 text-slate-500 group-hover:text-[#2D4F7A]">{totalText}{data.live ? " · Live Google rating" : " · Connect Google Places API for live count"}</p>
            </div>
          </a>
