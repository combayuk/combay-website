...
import { LayoutDashboard, Package, ShoppingCart, Wrench, RotateCcw, FileText, Tag, Receipt, LogOut, UsersRound, MessageSquare, RefreshCw, Sparkles, Mail, ClipboardCheck, Truck, UploadCloud, BookOpen, Activity } from "lucide-react";
...
const NAV = [
  ...
  { href:"/admin/resources",  label:"Resources",         icon:<BookOpen size={15}/> },
