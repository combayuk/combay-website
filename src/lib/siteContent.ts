...
const page=(p:Partial<CmsPage>):CmsPage=>({ eyebrow:"",heading:"",accent:"",body:"",backgroundImageUrl:"",heroImageUrl:"",primaryLabel:"",primaryHref:"#",secondaryLabel:"",secondaryHref:"#",sectionEyebrow:"",sectionHeading:"",sectionBody:"",blocks:[],steps:[],ctaHeading:"",ctaBody:"",ctaPrimaryLabel:"",ctaPrimaryHref:"#",ctaSecondaryLabel:"",ctaSecondaryHref:"#",sectionOrder:["hero","contactBar","content","process","formOrCta"],quoteImageUrl:"/images/about/industrial-supply-desk.svg",quoteName:"Combay Team",quoteDesignation:"Industrial equipment supply, repair and asset recovery",quoteText:"Combay was built for maintenance and procurement teams who need practical answers: is the item available, what condition is it in, can it be repaired, and how quickly can it move?",...p });
...
function upgradeAboutPage(p: CmsPage): CmsPage {
  ...
  if (p.body.trim() === shortBody || p.sectionBody.trim() === shortSection || p.blocks.length <= 3) {
    return defaultSiteContent.pages.about;
  }
  return p;
}
