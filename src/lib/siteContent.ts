...
export const defaultSiteContent: SiteContent = {
  ...
  trust:{eyebrow:"Why Businesses Use Combay",heading:"Built by engineers,",accent:"for engineers.",clients:["Nutrein","AG Solutions","Fiber Logic","Poole IT","Transend (UK) Ltd"],backgroundImageUrl:"/images/hero/industrial-automation-bg.svg"},
